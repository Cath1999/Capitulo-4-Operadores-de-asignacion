...
// Analisis de los resultados de un examen, utilizando instrucciones de controlanidadas.
...
reprobados = reprobados + 1;
 // i ncrementa contadorEstudiantes, para que el ciclo termine en unmomento dado
